(function annoletContainer(){
    ...
    linktag.href = "https://cdn.rawgit.com/renarration-studio/webpage-transformation-tool/8e394500/css/annolet.css"; 
    ...
    "<ul id='annolet-menu' >"+
        ...
        "<select class='select-menu' >"+
            "<option value='volvo'>Switch to Theme1</option>"+
            "<option value='saab'>Switch to Theme2</option>"+
            "<option value='mercedes'>Switch to Theme3</option>"+
        "</select>"+
    "</ul>";
}());
